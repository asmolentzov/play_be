...
const destroy = (id) => database('playlists').where('id', id).delete();

const update = (id, newPlaylist) => database('playlists').where('id', id).update(newPlaylist, ['playlist_name']);

module.exports = {all, find, create, destroy, update}
